...
3) Access the `workbench` named `chatbot-release-010x-test-notebook`.
...
5) In the terminal, run `cd chatbot-release-010x-test` to navigate to your sample app's directory.
